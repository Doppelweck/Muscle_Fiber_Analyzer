...
buildOpts.ExecutableIcon = fullfile(projectRoot, "Icons", "Icon2.png");
buildOpts.ExecutableName = "MuscleFiberAnalyzer_v1_6_1";
buildOpts.ExecutableVersion = "1.6.1";
...
packageOpts.ApplicationName = "Muscle Fiber Analyzer v1.6.1";
...
packageOpts.InstallerIcon = fullfile(projectRoot, "Icons", "Icon2.png");
packageOpts.InstallerLogo = fullfile(projectRoot, "Icons", "Icon_Big_Hoch.png");
packageOpts.InstallerName = "Muscle_Fiber_Analyzer_1-6-1_Installer";
