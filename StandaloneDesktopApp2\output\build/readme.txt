Muscle_Fiber_Analyzer Executable
...
================================
-run_Muscle_Fiber_Analyzer.sh (shell script for temporarily setting environment variables 
                               and executing the application)
   -to run the shell script, type
   
       ./run_Muscle_Fiber_Analyzer.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2025a, run the shell script as:
       ...
       ./run_Muscle_Fiber_Analyzer.sh /mathworks/home/application/R2025a
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_Muscle_Fiber_Analyzer.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure Muscle_Fiber_Analyzer.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r Muscle_Fiber_Analyzer.zip Muscle_Fiber_Analyzer.app
    or the tar command 
    tar -cvf Muscle_Fiber_Analyzer.tar Muscle_Fiber_Analyzer.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/R2025a/runtime/maca64:MR/R2025a/sys/os/maca64:MR/R2025a/bin/maca64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_Muscle_Fiber_Analyzer.sh 
