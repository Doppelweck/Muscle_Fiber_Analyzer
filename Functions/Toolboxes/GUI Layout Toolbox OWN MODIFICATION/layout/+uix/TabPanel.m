    ...
    methods
        ...
        function obj = TabPanel( varargin )
            ...
            dividers = matlab.ui.control.UIControl( 'Internal', true, ...
                'Parent', obj, 'Units', 'pixels', 'Style', 'text',...
                'Tag', 'TabPanelDividers', 'Visible','off' );
        ...
        function redrawTabs( obj )
            ...
            for ii = 1:t
                ...
                if ii == selection
                    ...
                    tab.ForegroundColor = foregroundColor;
                else
                    tab.BackgroundColor = tint * backgroundColor;
                    tab.ForegroundColor = foregroundColor;
                end
            end
            ...
            map = [obj.ShadowColor; obj.BackgroundColor; ...
                tint * obj.BackgroundColor; obj.HighlightColor;...
