...
label_1 = uicontrol('Style', 'text', 'Parent', modalFig, 'Position', [20, modalFigHeight-40, modalFigWidht-250, 24], 'String', getSettingsValue('AppName'));
...
hlinkMail = uihyperlink(modalFig, ...
    'Position', [70, 545, 305, 20], ...
    'Text', text, ...
    'URL', url, ...
    'FontSize', 16);
...
text = 'Google Drive';
hlinkDrive = uihyperlink(modalFig, ...
    'Position', [70, 350, 110, 20], ...
    'Text', text, ...
    'URL', url, ...
    'FontSize', 16);

text = url;
hlinkDrive2 = uihyperlink(modalFig, ...
    'Position', [70, 330, 555, 20], ...
    'Text', text, ...
    'URL', url, ...
    'FontSize', 12);
...
text = 'Github.com';
hlinkGit = uihyperlink(modalFig, ...
    'Position', [70, 270, 90, 20], ...
    'Text', text, ...
    'URL', url, ...
    'FontSize', 16);

text = url;
hlinkGit2 = uihyperlink(modalFig, ...
    'Position', [70, 250, 350, 20], ...
    'Text', text, ...
    'URL', url, ...
    'FontSize', 12);
...
text = 'PayPal.com';
hlinkPP = uihyperlink(modalFig, ...
    'Position', [70, 190, 90, 20], ...
    'Text', text, ...
    'URL', url, ...
    'FontSize', 16);

text = url;
hlinkPP2 = uihyperlink(modalFig, ...
    'Position', [70, 170, 175, 20], ...
    'Text', text, ...
    'URL', url, ...
    'FontSize', 12);
