...
params.default_panel = {'FontSize',params.fontSizeB,'BorderWidth',2,'Padding', 2, 'Tag','mainPanelsViews'};
params.default_tab_panel = {'FontSize',params.fontSizeB,'Padding', 2};
